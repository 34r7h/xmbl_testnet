...
# Build MAYO WASM module from the vendored fork (xid/mayo-cube), producing a
# second, independent WASM artifact. Sibling of build-mayo-wasm.sh — same
# Emscripten flags/exported functions, paths retargeted at mayo-cube. See
# mayo-cube/VENDOR.md for provenance.
cd "$(dirname "$0")"

MAYO_SRC="mayo-cube/src"
OUTPUT_DIR="mayo-cube"
OUTPUT_JS="$OUTPUT_DIR/mayo.js"
OUTPUT_WASM="$OUTPUT_DIR/mayo.wasm"

echo "Building MAYO-cube WASM module..."
